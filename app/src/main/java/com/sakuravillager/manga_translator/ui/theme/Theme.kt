...
// Dynamic color schemes generated from system wallpaper
@Composable
private fun DynamicColorScheme(darkTheme: Boolean) = when {
...
fun MangaTranslatorTheme(
    ...
    val resolvedColorScheme = when {
        ...
        colorSchemeName == "system" || colorSchemeName == "dynamic" -> DynamicColorScheme(isDarkMode)
